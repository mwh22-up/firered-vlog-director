...
class SchemaValidationTests(unittest.TestCase):
    ...
    def test_every_formal_json_artifact_matches_its_schema(self) -> None:
        ...
        expected_counts = {
            "reference-analysis.schema.json": 18,
            "reference-technique-study.schema.json": 19,
        ...
        self.assertEqual(len(formal_reference_paths), 50)
    ...
    def test_all_repository_json_documents_are_parseable(self) -> None:
        ...
        self.assertEqual(len(json_paths), 89)
