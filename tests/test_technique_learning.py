...
class TechniqueLearningTests(unittest.TestCase):
    ...
    def test_twenty_six_formal_studies_keep_the_learning_baseline(self) -> None:
        ...
        self.assertEqual(len(studies), 26)
        self.assertEqual(observation_count, 375)
        self.assertEqual(len(unique_keys), 145)
        ...
        self.assertEqual(aggregate["source_count"], 26)
        self.assertEqual(aggregate["minimum_source_support"], 2)
        self.assertEqual(len(aggregate["stable_patterns"]), 58)
